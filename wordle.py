...
def main():
    ...
    print("Hello, welcome to wordle. You must guess the correct ", word_length, " word.")
    c_mod = "*"
    p_mod = "_"
    print("If you get the correct place, you will see ", c_mod, "surrouding the letter.")
    print("If you get the correct letter but wrong place, you will see ", p_mod, "surrouding the letter.")
    ...
    while not hanged:
        all_correct, all_wrong_place, all_wrong, print_guess, guess = update_status(words, word, all_correct, all_wrong_place, all_wrong)
        previous_guesses_status.append( print_guess)
        
        print_status( all_correct, all_wrong_place, all_wrong, alphabet, previous_guesses_status)
...
def print_status(all_correct, all_wrong_place, all_wrong, alphabet, previous_guesses_status):
    print("Letters guessed correct: ", "".join(all_correct), " Letters guessed in wrong place still: ", "".join(all_wrong_place), " Letters guessed wrong: ", "".join(all_wrong))
    print("Letters left:", "".join(l for l in alphabet if l not in (all_correct | all_wrong_place | all_wrong)))
